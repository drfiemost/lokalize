...
void GlossarySortFilterProxyModel::fetchMore([[maybe_unused]] const QModelIndex& parent)
{
...
bool GlossaryModel::canFetchMore([[maybe_unused]] const QModelIndex& parent) const
{
